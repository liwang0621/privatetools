...
# ]
IMAGE_FILES = glob('/home/liwang/data/shopee_shoes/spu_comment/images_v2/*.jpg')

pabr = tqdm(total=len(IMAGE_FILES))
save_root = '/home/liwang/data/shopee_shoes/spu_comment/images_mediapipe_2d_res_0.7'
os.makedirs(save_root, exist_ok=True)

f = open('/home/liwang/data/foot_det/shopee_shoes/anno_v2.txt', 'w')
with mp_objectron.Objectron(static_image_mode=True,
    ...
    for idx, file in enumerate(IMAGE_FILES):
        ...
        for detected_object in results.detected_objects:
            ...
            boxes.append(box)
        # img = draw_box(annotated_image, boxes)
        # cv2.imwrite(os.path.join(save_root, name), annotated_image)

        img_anno_str = ' '
        for box in boxes:
             assert len(box) == 4
             img_anno_str += '{} {} {} {} {} '.format(box[0], box[1], box[2], box[3], 1)
        img_anno = name + " {} {} {}".format(w, h, len(boxes)) + img_anno_str
