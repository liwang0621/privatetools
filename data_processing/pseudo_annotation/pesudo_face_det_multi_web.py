...
LastEditors  : Li Wang
LastEditTime : 2022-03-21 10:08:17
FilePath     : /data_processing/pseudo_annotation/pesudo_face_det_multi_web.py
Description  : 
'''
import os
from re import I
...
def worker(procnum, image_paths_worker, device, return_dict):
...
def main():
    ...
    image_list_path = '/home/liwang/data/gongyinglian/photos_100000.txt'
    ...
    for i in range(multithread):
        ...
        p = multiprocessing.Process(target=worker, args=(i, image_paths_worker, device, return_dict))
        jobs.append(p)
        p.start()
