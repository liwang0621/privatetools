...
if __name__ == '__main__':
    ...
    meta = []
    with open('/Users/wang.li/data/live_tag_data/tag_mining/gmv_id_good.txt', 'r') as f:
        for line in f.readlines()[:1000]:
            ...
            meta.append([session_id, gmv, record_url])

    data['good'] = meta

    meta = []
    with open('/Users/wang.li/data/live_tag_data/tag_mining/gmv_id_middle.txt', 'r') as f:
        for line in f.readlines()[:1000]:
            tmp = line.split()
            gmv = float(tmp[0])
            session_id = str(tmp[1])
    ...
    meta = []
    with open('/Users/wang.li/data/live_tag_data/tag_mining/gmv_id_bad.txt', 'r') as f:
        for line in f.readlines()[:1000]:
            tmp = line.split()
            gmv = float(tmp[0])
            session_id = str(tmp[1])
    ...
    json.dump(data, open('/Users/wang.li/data/live_tag_data/tag_mining/tag_mining_gmv_training_data.json', 'w'))
